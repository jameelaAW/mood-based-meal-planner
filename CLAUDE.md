...
A mood-based meal planner that asks how you feel, suggests a comforting-yet-healthy recipe, and generates a weekly shopping list based on your emotional state.
